...
if ($application) {
    Write-Host "A previous install of the Liongard Agent was found! Uninstalling the Liongard Agent."
    $application.Uninstall()
    }
elseif ($application2) {
    Write-Host "A previous install of the Liongard Agent was found! Uninstalling the RoarAgent."
